...
class TitleState extends MusicBeatState
{
	...
	function startIntro()
	{
		...
		var bg:FlxSprite = new FlxSprite().loadGraphic("assets/images/TitleState/titleBG.png");
		add(bg);

		logoBl = new FlxSprite(-150, -100);
		logoBl.frames = FlxAtlasFrames.fromSparrow('assets/images/TitleState/logoBumpin.png', 'assets/images/TitleState/logoBumpin.xml');
		...
		swagShader = new ColorSwap();
		gfDance = new Character(titleJSON.gfx, titleJSON.gfy);
		...
		switch(easterEgg.toUpperCase())
		{
			...
			//EDIT THIS ONE IF YOU'RE MAKING A SOURCE CODE MOD!!!!
			//EDIT THIS ONE IF YOU'RE MAKING A SOURCE CODE MOD!!!!
			gfDance = new FlxSprite(0, 100);
			gfDance.antialiasing = true;
			gfDance.frames = Paths.getSparrowAtlas('TitleState/FLIPPY_onslaught');
			gfDance.animation.addByPrefix('idle', 'FLIPPY Idle', 24);
	...
	override function beatHit()
	{
		...
		if(!closedState) {
			...
			switch (sickBeats)
			{
				...
				// credTextShit.text += '\nNight';
				case 15:
					addMoreText('Flipped Out!'); // credTextShit.text += '\nFunkin';
